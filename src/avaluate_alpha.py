...
# =========================
RUN_FILES = {
    "alpha_0.0 (BM25)": Path(r"D:\IR\demo\run\runs_search_bm25\bm25_1.2_0.75.txt"),
    "alpha_0.2": Path(r"D:\IR\demo\run\runs_search_bm25\bm25_sentiment_ml_1.2_0.75_a0.2.txt"),
    "alpha_0.5": Path(r"D:\IR\demo\run\runs_search_bm25\bm25_sentiment_ml_1.2_0.75_a0.5.txt"),
    "alpha_1.0": Path(r"D:\IR\demo\run\runs_search_bm25\bm25_sentiment_ml_1.2_0.75_a1.0.txt"),
}

QRELS_FILE = RESULTS_DIR / "qrels_ratio.txt"
OUTPUT_FILE = RESULTS_DIR / "evaluate_sentiment.txt"
